...
template OrderLeaf(){
    ...
    signal output (txId, cumAmt0, cumAmt1, lockedAmt, cumFeeAmt, creditAmt) <== (arr[LenOfReq()], arr[LenOfReq() + 1], arr[LenOfReq() + 2], arr[LenOfReq() + 3], arr[LenOfReq() + 4], arr[LenOfReq() + 5]);
}
